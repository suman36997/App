...
lbl_brightness=Label(RHS,text='Brightness',font=('ariel',10,'bold'),bg="#f4f5f5")
...
def weather():
    ...
    def getWeather():
        try:
            city=textfield.get()
            geolocator=Nominatim(user_agent="geopaiExercises")
    ...
    t=Label(app1,font=('ariel',60,'bold'),fg='#ee666d',bg='#f4f5f5')
    t.place(x=400,y=150)
    c=Label(app1,font=('ariel',25,'bold'),bg='#f4f5f5')
    c.place(x=400,y=250)

    w=Label(app1,text="...",font=('ariel',18,'bold'),bg="#1ab5ef")
    w.place(x=120,y=430)
    h=Label(app1,text="...",font=('arial',18,'bold'),bg="#1ab5ef")
    h.place(x=270,y=430)
    d=Label(app1,text="...",font=('arial',18,'bold'),bg="#1ab5ef")
    d.place(x=420,y=430)
    p=Label(app1,text="...",font=('arial',18,'bold'),bg="#1ab5ef")
    p.place(x=670,y=430)
...
def close_apps():
    wb.register('chrome',None)
    wb.open('https://www.linkedin.com/in/pranjal-prince-824490219/')
